      ...
      <article className="cv" aria-labelledby="cv-title">
        <header className="cv__header">
          ...
          <div className="cv__intro">
            <p className="cv__headline">{cv.metadata.headline}</p>
            <h1 className="cv__name" id="cv-title">
              {cv.metadata.name}
            </h1>
            <ul className="cv__meta" aria-label={cv.metadata.detailsLabel}>
              {cv.metadata.details.map((detail) => (
                <li key={detail.label}>
                  <span className="cv__meta-label">{detail.label}</span>
                  <span>{detail.value}</span>
                </li>
              ))}
            </ul>
          </div>
          <aside className="cv__contact" aria-labelledby="contact-title">
        ...
        <main className="cv__main" id="main-content">
